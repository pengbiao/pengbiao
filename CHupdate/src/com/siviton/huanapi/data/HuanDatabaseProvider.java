...
public class HuanDatabaseProvider extends ContentProvider{
	private static final String TAG = "HuanDatabaseProvider";
	private HuanSQLiteHelper mOpenHelper;
    // database name
	private static final String DATABASE_NAME =HuanApi.DATABASE_NAME;
 	//table name
	private static final String TABLE_NAME = HuanApi.TABLE_NAME;
	private static final String CONTENT_LABEL = "content://";
    // authority
	private static final String AUTHORITY = HuanApi.AUTHORITY;
	private static final String MARK_SLASH = "/";
 	//uri
//	private static final String URI = CONTENT_LABEL + AUTHORITY + MARK_SLASH + TABLE_NAME;
	private static final Uri CONTENT_URI = HuanApi.CONTENT_URI;
    ...
    //_id
 	private static final String DATABASE_ID = HuanApi.COLUMN_ID;
    //equal operator
	...
	public Uri insert(Uri uri, ContentValues values) {
		System.out.println("======pengbdata==insert======");
		SQLiteDatabase sqlDatabase = mOpenHelper.getWritableDatabase();
	...
	public boolean onCreate() {
		mOpenHelper = new HuanSQLiteHelper(getContext(),DATABASE_NAME,null,1);
		return true;
	}
